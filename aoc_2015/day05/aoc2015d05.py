...
soln_file = script_path / "input.txt"  # 238 /69
test_file = script_path / "test.txt"  # nice, nice, naughty, naughty, naughty = 2 nice
test_file2 = script_path / "test2.txt"  # nice, nice, naughty, naughty = 2 nice
