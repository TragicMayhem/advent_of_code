...
soln_file = script_path / "input.txt"  #  11266889531 / 77387711
test_file = (
    script_path / "test.txt"
)  #  Num parcels 10 with total weight of 60 Group target weight is 20.0  > 99
...
def calc_weight_groups(weight_list, num_of_groups):
    ...
    print("-" * 50)
    print(
        f"Solving for {len(weight_list)} parcel weights and {num_of_groups} groups and target of {target_weight}"
    )
