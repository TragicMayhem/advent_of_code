...
def part1(data):
    ...
    while (player_stats['1']['score']<target_score_part1 and player_stats['2']['score']<target_score_part1):
...
@functools.lru_cache(maxsize=None)
def check_for_win(next_player_pos, other_player_pos, next_player_score, other_player_score):
    '''
    ...
    for roll_score, universe_count in universe_dice_rolls:
        ...
        if next_player_tmp_score >= target_score_part2:
            ...
            other_player_tmp_wins, next_player_tmp_wins = check_for_win(other_player_pos, next_player_tmp_pos, other_player_score, next_player_tmp_score)
