...
input = script_path / "input.txt"  # 12996997829399 / 11841231117189
...
def compute_model_numbers(data):
    ...
    highest_model_num_digits = [
        0
    ] * 14  # To store the individual digits will be 1-9 each
    lowest_model_num_digits = [
        0
    ] * 14  # To store the individual digits will be 1-9 each
